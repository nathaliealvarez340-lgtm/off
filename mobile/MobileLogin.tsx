...
export function MobileLogin({ next, initialMessage = "", initialLanguage }: { next: string; initialMessage?: string; initialLanguage?: string | null }) {
  ...
  return (
    <main className="off-mobile mobile-auth">
      ...
      <section className="mobile-auth-card">
        ...
        <AuthForms next={next} initialMessage={initialMessage} initialLanguage={initialLanguage} />
      </section>
